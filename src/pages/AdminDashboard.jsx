...
export default function AdminDashboard({ onNavigate }) {
  ...
  const handleSaveNewTournament = (e) => {
    ...
    const totalHorsesCount = createRacesList.reduce(
      (sum, r) => sum + (parseInt(r.horsesCount, 10) || 8),
      0,
    );
    ...
    <div className="admin-container d-flex">
      ...
      >
        <div>
          ...
          <div className="sidebar-logo d-flex align-items-center gap-2.5 p-4 border-bottom">
            ...
            <div>
              <span
                className="brand-title fw-bold text-dark-navy m-0 d-block"
                style={{
                  fontSize: "17px",
                  lineHeight: "1.2",
                  letterSpacing: "-0.3px",
      ...
      <main className="admin-main flex-grow-1 bg-cool-gray p-3 p-md-4">
        ...
        <div className="admin-main-header d-none d-lg-flex justify-content-between align-items-center mb-4">
          <h2
            className="h5 fw-bold text-dark-navy m-0"
        ...
        activeMenu === "Tournament management" ? (
          currentSubView === "create" ? (
            ...
            <div className="create-tournament-view">
              ...
              <h1 className="h3 fw-bold text-dark-navy mb-4">
              ...
              <form onSubmit={handleSaveNewTournament}>
                ...
                <div className="card border-0 shadow-sm rounded-3 p-4 bg-white mb-4 create-section-card">
                  <h3 className="h5 fw-bold text-dark-navy mb-3 create-section-title">
                    Tournament Details
                  </h3>
                  ...
                  <div className="row g-3">
                    ...
                    <div className="col-12 col-md-6">
                      <label
                        className="form-label text-secondary-custom fw-semibold mb-1.5"
                ...
                <div className="card border-0 shadow-sm rounded-3 p-4 bg-white mb-4 create-section-card">
                  <div className="d-flex justify-content-between align-items-center mb-3">
                    <h3 className="h5 fw-bold text-dark-navy m-0 create-section-title">
                      Races
                    </h3>
                    <button
                      type="button"
                      ...
                      <tbody>
                        {createRacesList.length > 0 ? (
                          ...
                          <tr>
                            <td
                              colSpan="8"
                              className="text-center py-4 text-muted border border-dashed rounded-3"
                            >
                              No races added. Use "+ Add Race Row" to create
                              races.
                            </td>
                          </tr>
                        )}
