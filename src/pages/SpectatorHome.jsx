...
const HORSES = [
  { id: 1, name: 'Lightning Strike', jockey: 'M. Smith', odds: '2/1', img: horseLightningImg },
  { id: 2, name: 'Midnight Runner', jockey: 'T. Clark', odds: '5/2', img: horseMidnightImg },
  ...
  { id: 8, name: 'Shadow Dancer', jockey: 'K. Thompson', odds: '15/1', img: '' },
  { id: 9, name: 'Wind Whisperer', jockey: 'P. Anderson', odds: '20/1', img: '' },
...
export default function SpectatorHome({ onNavigate }) {
  ...
  const handleSubmitBid = (e) => {
    ...
    if (points > walletBalance) {
      setBidError(`Insufficient balance. You only have ${walletBalance} points.`);
      return;
    }
    ...
    setTimeout(() => {
      ...
      setBidSuccessMsg(`Bid placed! You bid ${points} points on #${selectedWinner} ${horseName}.`);
      setBidPoints('');
      setSelectedWinner('');
    ...
    <div className="spectator-page-wrapper pb-5">
      ...
      <nav className="main-navbar d-flex justify-content-between align-items-center mb-4 shadow-sm py-2 px-3">
        ...
        <div className="desktop-nav d-flex align-items-center gap-1">
          <a
            href="#races"
            onClick={(e) => { e.preventDefault(); setActiveTab('races'); }}
          ...
          <a
            href="#horse"
            onClick={(e) => { e.preventDefault(); setActiveTab('horse'); }}
        ...
        <div className="d-flex gap-2 align-items-center">
          <div className="bg-light px-3 py-1 rounded-pill border d-none d-sm-flex align-items-center gap-2" style={{ fontSize: 13 }}>
      ...
      <div className="spectator-content-container">
        ...
        <div className="d-flex justify-content-between align-items-center mb-4">
          ...
          <a href="#past-events" className="text-decoration-none text-primary-custom fw-semibold d-flex align-items-center gap-1 hover-primary" style={{ fontSize: '14px' }}>
        ...
        <div className="tournament-list">
          ...
          <div className="tournament-card">
            <div 
              ...
              onClick={() => setExpandedTournament(expandedTournament === 'spring-prestige' ? '' : 'spring-prestige')}
            >
              <div className="d-flex align-items-center gap-3">
                <div className="bg-light-blue p-2 rounded-3 text-primary-custom d-flex align-items-center justify-content-center" style={{ backgroundColor: 'rgba(27, 96, 236, 0.08)', width: 44, height: 44 }}>
                  <i className="bi bi-trophy fs-5 text-primary-custom"></i>
                </div>
                <div>
                  <h2 className="h5 fw-bold text-dark-navy mb-0" style={{ fontSize: '17px' }}>Spring Prestige</h2>
                  <span className="text-secondary-custom" style={{ fontSize: '13px' }}>4 Races • Apr 12 - May 15</span>
                </div>
              </div>
              <button className="btn border-0 p-1 text-secondary-custom">
                <i className={`bi ${expandedTournament === 'spring-prestige' ? 'bi-chevron-up' : 'bi-chevron-down'} fs-5`}></i>
              </button>
            </div>
            ...
            {expandedTournament === 'spring-prestige' && (
              <div className="tournament-body p-3 p-md-4">
                ...
                <div className={`race-accordion-item ${expandedRace === 'race-1' ? 'is-expanded' : ''}`}>
                  <div 
                    className="race-accordion-header"
                    onClick={() => setExpandedRace(expandedRace === 'race-1' ? '' : 'race-1')}
                  >
                    <div className="d-flex align-items-center gap-3">
                      <div className="race-status-col">
                        <span className="pulsing-live-badge text-uppercase text-center w-100 m-0">Live</span>
                      </div>
                      <span className="fw-bold text-dark-navy">Race 1: Sprint Stakes</span>
                    </div>
                    <button className="btn border-0 p-1 text-secondary-custom">
                      <i className={`bi ${expandedRace === 'race-1' ? 'bi-dash-lg' : 'bi-plus-lg'}`}></i>
                    </button>
                  </div>
                      ...
                      <div className="row g-4">
                        ...
                        <div className="col-12 col-lg-8">
                          ...
                          <div className="d-flex justify-content-between align-items-center mb-3">
                            <span className="text-uppercase fw-bold text-secondary-custom" style={{ fontSize: '12px', letterSpacing: '0.5px' }}>
                              Live Track Position
                            </span>
                            ...
                            <div className="d-flex align-items-center gap-2">
                              ...
                              >
                                <i className={`bi ${isSimulating ? 'bi-pause-fill' : 'bi-play-fill'}`}></i>
                          ...
                          <div className="participating-teams-section">
                            <h3 className="text-uppercase fw-bold text-secondary-custom mb-3" style={{ fontSize: '12px', letterSpacing: '0.5px' }}>
                              Participating Teams
                            </h3>
                            <div className="row g-3">
                              {HORSES.map(horse => (
                                <div key={horse.id} className="col-12 col-sm-6 col-md-4 col-lg-6">
                                  <div className="participating-team-card">
                                    {horse.img ? (
                                      ...
                                      <div className="team-horse-img border bg-light d-flex align-items-center justify-content-center" style={{ width: 54, height: 54, borderRadius: 8 }}>
                                        <i className="bi bi-image text-muted fs-4"></i>
                                      </div>
                                    )}
                                    <div className="flex-grow-1">
                                      <div className="d-flex justify-content-between align-items-start">
                                        <span className="fw-bold text-primary-custom" style={{ fontSize: '14px' }}>#{horse.id}</span>
                                        <span className="odds-badge">{horse.odds}</span>
                                      </div>
                                      <h4 className="fw-bold text-dark-navy mb-0" style={{ fontSize: '15px' }}>{horse.name}</h4>
                                      <span className="text-secondary-custom" style={{ fontSize: '12px' }}>
                                        <i className="bi bi-person me-1"></i>Jockey: <strong>{horse.jockey}</strong>
                                      </span>
                                    </div>
                                  </div>
                                </div>
                          ...
                          <div className="prediction-card h-100 d-flex flex-column justify-content-between">
                            <div>
                              <div className="prediction-title text-uppercase mb-3">
                                <i className="bi bi-sparkles"></i> Make a Prediction
                              </div>

                              {bidSuccessMsg && (
                                <div className="alert alert-success alert-dismissible fade show p-2 mb-3" style={{ fontSize: '13px' }} role="alert">
                                  <i className="bi bi-check-circle-fill me-1"></i> {bidSuccessMsg}
                                  <button type="button" className="btn-close p-2" onClick={() => setBidSuccessMsg('')} aria-label="Close"></button>
                                </div>
                              )}

                              {bidError && (
                                <div className="alert alert-danger p-2 mb-3" style={{ fontSize: '13px' }}>
                                  <i className="bi bi-exclamation-triangle-fill me-1"></i> {bidError}
                                </div>
                              )}

                              <form onSubmit={handleSubmitBid}>
                                <div className="mb-3">
                                  <label htmlFor="selectWinner" className="form-label text-secondary-custom fw-semibold mb-1" style={{ fontSize: '13px' }}>
                                    Your Winner
                                  </label>
                                  <select 
                                    id="selectWinner"
                                ...
                                <div className="d-flex gap-2">
                                  ...
                                  >
                                    {isSubmittingBid ? (
                                      ...
                                      <>Submit Bid <i className="bi bi-arrow-right-short fs-5"></i></>
                                    )}
                                  </button>
                                </div>
                              </form>
                            ...
                            <div className="mt-4 pt-3 border-top d-sm-none">
                              <div className="d-flex justify-content-between align-items-center">
                                <span className="text-secondary-custom" style={{ fontSize: '13px' }}>Wallet Balance:</span>
                                <span className="fw-bold text-dark-navy">{walletBalance} points</span>
                              </div>
                            </div>
                          </div>
                        </div>
                ...
                <div className={`race-accordion-item ${expandedRace === 'race-2' ? 'is-expanded' : ''}`}>
                  <div 
                    className="race-accordion-header"
                    onClick={() => setExpandedRace(expandedRace === 'race-2' ? '' : 'race-2')}
                  >
                    <div className="d-flex align-items-center gap-3">
                      <div className="race-status-col text-secondary-custom fw-semibold">
                        <span>14:30</span>
                      </div>
                      <span className="fw-bold text-dark-navy">Race 2: Golden Cup</span>
                    </div>
                    <button className="btn border-0 p-1 text-secondary-custom">
                      <i className={`bi ${expandedRace === 'race-2' ? 'bi-dash-lg' : 'bi-plus-lg'}`}></i>
                    </button>
                  </div>
                  ...
                  {expandedRace === 'race-2' && (
                    <div className="race-accordion-body">
                      <p className="text-muted mb-0" style={{ fontSize: '13px' }}>
                        This race starts at 14:30. Predictions will open 1 hour before the event.
                      </p>
                    </div>
                  )}
                </div>
          ...
          <div className="tournament-card">
            <div 
              className="tournament-header d-flex justify-content-between align-items-center"
              onClick={() => setExpandedTournament(expandedTournament === 'summer-derby' ? '' : 'summer-derby')}
            >
              <div className="d-flex align-items-center gap-3">
                <div className="bg-light-blue p-2 rounded-3 text-warning d-flex align-items-center justify-content-center" style={{ backgroundColor: 'rgba(255, 193, 7, 0.08)', width: 44, height: 44 }}>
                  <i className="bi bi-brightness-high fs-5 text-warning"></i>
                </div>
                <div>
                  <h2 className="h5 fw-bold text-dark-navy mb-0" style={{ fontSize: '17px' }}>Summer Derby Series</h2>
                  <span className="text-secondary-custom" style={{ fontSize: '13px' }}>6 Races • Jun 01 - Jul 20</span>
                </div>
              </div>
              <button className="btn border-0 p-1 text-secondary-custom">
                <i className={`bi ${expandedTournament === 'summer-derby' ? 'bi-chevron-up' : 'bi-chevron-down'} fs-5`}></i>
              </button>
            </div>
            ...
            {expandedTournament === 'summer-derby' && (
              <div className="tournament-body p-3 p-md-4">
                <p className="text-muted mb-0" style={{ fontSize: '13px' }}>
                  This tournament details are not yet active. Check back later in June!
                </p>
              </div>
            )}
          </div>
