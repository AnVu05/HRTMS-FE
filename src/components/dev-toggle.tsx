...
export function DevToggle() {
  ...
  const routes = [
    ...
    },
    {
      ...
      items: [
        { label: 'Home', path: '/jockey/home' },
        { label: 'Profile', path: '/jockey/profile' },
        { label: 'Tournaments', path: '/jockey/tournaments' },
        { label: 'Races', path: '/jockey/races' },
        { label: 'Jockeys list', path: '/jockey/jockeys' },
      ],
    },
    {
      ...
      items: [
        { label: 'Home', path: '/referee/home' },
        { label: 'Profile', path: '/referee/profile' },
        { label: 'Tournaments', path: '/referee/tournaments' },
        { label: 'Races', path: '/referee/races' },
        { label: 'Jockeys list', path: '/referee/jockeys' },
      ],
    },
    {
      ...
      items: [
        { label: 'Home', path: '/spectator/home' },
        { label: 'Profile', path: '/spectator/profile' },
        { label: 'Tournaments', path: '/spectator/tournaments' },
        { label: 'Races', path: '/spectator/races' },
        { label: 'Jockeys list', path: '/spectator/jockeys' },
      ],
    },
  ];
