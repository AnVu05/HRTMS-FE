...
const PAGES = ['login', 'register', 'spectator-home'];

function App() {
  const [currentPage, setCurrentPage] = useState('spectator-home');
  ...
  return (
    <>
      ...
      {/* Page content */}
      <div 
        className={`app-page-container ${currentPage === 'spectator-home' ? 'full-width' : ''}`}
        style={{ paddingTop: currentPage === 'spectator-home' ? 0 : 40 }}
      >
        {renderPage()}
      </div>
    </>
